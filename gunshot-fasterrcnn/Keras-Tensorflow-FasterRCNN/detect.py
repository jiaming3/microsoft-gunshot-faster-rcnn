...
##########################################################################################################################
        ...
        for key in bboxes:
            ...
            for jk in range(new_boxes.shape[0]):
                ...
                data['start'].append(str(current_s+12000*(real_x1/640)))
                data['end'].append(str(current_s+12000*(real_x2/640)))
                ...
                if(str(key) == 'gunshot' or str(key) == 'shotgun' ):
                    ...
                    cv2.imwrite('dataset/detected/{}.png'.format(mylist[i]+str(current_s)+' '+ str(real_x1)+' '+str(real_y1)+' '+str(real_x2)+' '+str(real_y2)), img)
                if(str(key)== 'hn'):
                    hn_count+=1
